    ...
    <div class="layui-col-md6">
        <div class="layui-card">
            ...
            <div class="layui-card-body" style="padding: 15px;">
                <form:form servletRelativeAction="/sys/user/save" method="post" commandName="user" cssClass="layui-form" lay-filter="sys-user-create-form">
                    <input type="hidden" name="_csrf_token" value="${_csrf_token}">
                    <div class="layui-form-item">
                        <label class="layui-form-label">用户名称</label>
                        <div class="layui-input-block">
                            <form:input path="username" lay-verify="required" autocomplete="off" placeholder="请输入用户名称" cssClass="layui-input"></form:input>
                    ...
                    <div class="layui-form-item">
                        <div class="layui-input-block">
                            <div class="layui-footer" style="left: 0;">
                                <button type="submit" class="layui-btn" lay-submit lay-filter="sys-user-create-form-submit">保存</button>
