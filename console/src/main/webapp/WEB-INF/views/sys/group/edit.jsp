                ...
                <form:form servletRelativeAction="/sys/group/update" method="post" commandName="group" cssClass="layui-form" lay-filter="sys-group-edit-form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <form:input path="groupname" disabled="true" lay-verify="required" autocomplete="off" placeholder="请输入代码" cssClass="layui-input"></form:input>
                    ...
                    <div class="layui-form-item">
                        <div class="layui-input-block">
                            <div class="layui-footer" style="left: 0;">
                                <button type="submit" class="layui-btn" lay-submit lay-filter="sys-group-edit-form-submit">保存</button>
