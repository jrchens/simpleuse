    ...
    <div class="layui-layout layui-layout-admin">
            ...
            <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
                ...
                <li class="layui-nav-item" lay-unselect>
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <hr>
                        <dd style="text-align: center;"><a target="_top" href="${WEB_CONTEXT_PATH}/logout">退出</a></dd>
                    </dl>
                </li>
            ...
            <div class="layui-side-scroll">
                ...
                <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
                    ...
                    <li data-name="home" class="layui-nav-item layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <dd data-name="console" class="layui-this">
                                <a lay-href="${WEB_CONTEXT_PATH}/cms_user/index">用户管理</a>
                            </dd>
                            <dd data-name="console" class="layui-this">
                                <a lay-href="${WEB_CONTEXT_PATH}/cms_group/index">群组管理</a>
                            </dd>
                            <dd data-name="console" class="layui-this">
                                <a lay-href="${WEB_CONTEXT_PATH}/cms_role/index">角色管理</a>
                            </dd>
                            <dd data-name="console" class="layui-this">
                                <a lay-href="${WEB_CONTEXT_PATH}/cms_perm/index">权限管理</a>
                            </dd>
                            <dd data-name="console" class="layui-this">
                                <a lay-href="${WEB_CONTEXT_PATH}/cms_dir/index">目录管理</a>
                            </dd>
                            <dd data-name="console">
                                <a lay-href="${WEB_CONTEXT_PATH}/cms_article/index">文章管理</a>
                            </dd>
                        </dl>
                    </li>
        ...
        <div class="layadmin-pagetabs" id="LAY_app_tabs">
            ...
            <div class="layui-tab" lay-unauto lay-allowClose="true" lay-filter="layadmin-layout-tabs">
                <ul class="layui-tab-title" id="LAY_app_tabsheader">
                    <li lay-id="home/console.html" lay-attr="${WEB_CONTEXT_PATH}/console/index" class="layui-this"><i class="layui-icon layui-icon-home"></i></li>
                </ul>
            </div>
        </div>
        ...
        <div class="layui-body" id="LAY_app_body">
            <div class="layadmin-tabsbody-item layui-show">
                <iframe src="${WEB_CONTEXT_PATH}/sys/user/index" frameborder="0" class="layadmin-iframe"></iframe>
            </div>
        </div>
...
<script>
    layui.config({
        base: 'http://res.local.com/layuiadmin/' //静态资源所在路径
    }).extend({
